        ...
        for palavra in cfg["keywords"]:
            for cliente, fonte in clientes:
                try:
                    ...
                    falhas.append(f"{fonte} ('{palavra}', fallback): {exc}")
                    continue
    ...
    <div style="display:flex; align-items:center; gap:0.5rem; margin-top:0.35rem; flex-wrap:wrap;">
        <a
            ...
            style="
                ...
                background:#ffffff; color:#111111; opacity:1; font-size:0.72rem; font-weight:800;
                line-height:1; -webkit-text-fill-color:#111111;
            "
        >Abrir</a>
        <button
            type="button"
            ...
            style="
                ...
                gap: 0.35rem; padding: 0.36rem 0.76rem; border: 1px solid #d8d5d0;
                border-radius:999px; background:#ffffff; color:#111111; opacity:1; text-shadow:none;
                cursor: pointer; font-size: 0.72rem; font-weight: 800; line-height: 1; -webkit-text-fill-color:#111111;
            "
        >Copiar</button>
    </div>
    """
